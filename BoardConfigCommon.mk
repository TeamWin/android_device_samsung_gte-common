...
TARGET_SPECIFIC_HEADER_PATH := device/samsung/gt58-common/include
...
# Custom RIL class
BOARD_RIL_CLASS := ../../../device/samsung/gt58-common/ril/

# NFC
BOARD_HAVE_NFC := true

# GPS
TARGET_GPS_HAL_PATH := device/samsung/gt58-common/gps
...
# CMHW
BOARD_HARDWARE_CLASS += device/samsung/gt58-common/cmhw
...
BOARD_SEPOLICY_DIRS += \
    device/samsung/gt58-common/sepolicy
